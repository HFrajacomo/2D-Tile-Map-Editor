...
add([559,560,561,586,587,159,160,161,162,180,181,182,186,189,194,405,438,399,400,
...
add([110,114,115,116], OpenDoor)
add(range(168,174), Sack)
add(174, Anvil)
add(range(176,180), Forge)
add(range(201,207), OakTree)
add(range(219,225), PineTree)
add([389,408,427,432,433,445,319,448,321,449,323,451,336,338,341,357], Cupboard)
